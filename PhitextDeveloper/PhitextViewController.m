...
#import "PhitextViewController.h"

@implementation PhitextViewController
...
- (IBAction)changeTileWidth:(id)sender {
	...
	} else if (768 - 4 <= tileWidthHint && tileWidthHint <= 768 + 4) {
        tileWidthHint = 768;
        tileWidthLabel.textColor = [UIColor blackColor];
    } else if (640 - 4 <= tileWidthHint && tileWidthHint <= 640 + 4) {
        tileWidthHint = 640;
        tileWidthLabel.textColor = [UIColor blackColor];
    } else if (320 - 4 <= tileWidthHint && tileWidthHint <= 320 + 4) {
        tileWidthHint = 320;
        tileWidthLabel.textColor = [UIColor blackColor];
    } else {
